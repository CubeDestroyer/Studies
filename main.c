/*
 This is my retake on this ROM,because the code I used earlier turned out to be
 horrible
*/
...
unsigned int numPattern[10] = {0x3f, 0x6,  0x5b, 0x4f, 0x66,
                               0x6d, 0x7d, 0x7,  0x7f, 0x6f},
             digits[4] = {0, 0, 0, 0};

volatile unsigned int counterTemp = 0, counterConst = 0, time = 0,
                      sensitivity = 250, result = 0, resultOld = 0, limit = 45;
...
int main() {
  ...
  TIMSK |= (1 << OCIE1A);  // timer/counter 1 interrupt when overflown enabled
